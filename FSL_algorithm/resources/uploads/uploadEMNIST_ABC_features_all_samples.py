...
def uploadEMNIST(seed_set, device, batch_size):    
    ...
    mask = [1 if trainset[i][1] == 1 or trainset[i][1] == 2 or trainset[i][1] == 3 else 0 for i in range(len(trainset))]
    ...
    mask1 = [1 if trainset[i][1] == 1 or trainset[i][1] == 2 or trainset[i][1] == 3 else 0 for i in range(len(valset))]
