#############################################################################################################
# Federated Split Learning: fix partition size and vary dataset
...
def run_model(device, dataloaders, data, constant):
    ...
    wd = os.path.join(constant.PD, 'm2_nop_reconstruction_client_'+str(constant.CLIENTS)+"_fix_partition_size_vary_dataset_base_"+str(constant.MAXCLIENTS))+"_dist"
