...
def uploadMNIST(seed_set, device, batch_size, flag):
    ...
    if(flag == 'diffDistrmodel1'):
        ...
        #trainloader = torch.utils.data.DataLoader(mnist, batch_size=batch_size,sampler = sampler,shuffle=False, worker_init_fn=seed_set, pin_memory=False, drop_last=True)
