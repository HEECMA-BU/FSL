...
def run_model(device, dataloaders, data, constant):
    ...
    wd = os.path.join(constant.PD, "m2_alt_"+str(constant.PARAM)+"_reconstruction_vary_partition_size_fix_dataset_"+str(constant.CLIENTS)+"_base_"+str(constant.MAXCLIENTS))
